...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NORTH = 4,                      /* NORTH  */
  YYSYMBOL_SOUTH = 5,                      /* SOUTH  */
  YYSYMBOL_EAST = 6,                       /* EAST  */
  YYSYMBOL_WEST = 7,                       /* WEST  */
  YYSYMBOL_8_n_ = 8,                       /* '\n'  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "START", "NORTH",
  "SOUTH", "EAST", "WEST", "'\\n'", "$accept", "input", "line", "S", "D", YY_NULLPTR
};
